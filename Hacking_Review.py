...
if __name__ == "__main__":
    ...
    #print('It is observed above that column, Cabin, which is a categorical feature, has greater than 50% or around 77% of null values. Thus, column, Cabin will be dropped from the dataset.')
    data = data.drop(['Cabin'], axis = 1)

    #print('dropping the PassengerId index column from the given dataset.')
    data.reset_index(drop = True, inplace = True)

    #print('checking non-numeric values if there are any in columns i.e., Age and Fare - it is found that there are no such values.')
    ...
    print('Relationship between Age and Surived')
    print('\n')
    annova_krushkal(data, 'Age')
    print('\n')
    print('Both One-way ANOVA test and Krushkal test show the p value > 0.05. Thus, there is NO strong relationship between Age and Survived.')   
    print('\n')
    print('Relationship between Fare and Survived')
    print('\n')
    annova_krushkal(data, 'Fare')
    print('\n')
    print('The above tests suggest that Fare has an strong impact on Survived variable.')
    print('\n')
    print('Column, Age can be dropped from the dataset based on the above results of statistical tests.')
    print('\n')
    ...
    # changing the data type of Y to categorical data type
    Y = Y.astype('category')
